package mip.mva.verifier.comm.vo;

import java.io.Serializable;

/**
 * @Project     : 모바일 운전면허증 서비스 구축 사업
 * @PackageName : mip.mva.verifier.config.ConfigBean
...
public class TrxInfoVO implements Serializable {
	...
	public String toString() {
		return "TrxInfoVO [trxcode=" + trxcode + ", svcCode=" + svcCode + ", mode=" + mode + ", deviceId=" + deviceId
				+ ", branchName=" + branchName + ", nonce=" + nonce + ", zkpNonce=" + zkpNonce + ", vpVerifyResult="
				+ vpVerifyResult + ", trxStsCode=" + trxStsCode + ", profileSendDt=" + profileSendDt + ", imgSendDt="
				+ imgSendDt + ", vpReceptDt=" + vpReceptDt + ", errorCn=" + errorCn + ", regDt=" + regDt + ", udtDt="
				+ udtDt + "]";
	}

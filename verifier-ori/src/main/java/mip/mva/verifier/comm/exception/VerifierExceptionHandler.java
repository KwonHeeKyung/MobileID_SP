 ...
 * @FileName    : VerifierExceptionHandler.java
 * @Author      : Min Gi Ju
 * @Date        : 2022. 6. 8.
 * @Description : Verifier Exception Controller Advice
 * ==================================================
 * DATE            AUTHOR           NOTE
 * ==================================================
...
public class VerifierExceptionHandler {
	...
	/**
	 * Verifier Excpetion 핸들러
	 * 
	 * @MethodName : handleSpException
	 * @param e Verifier Exception
	 * @return
	 */
	@ExceptionHandler(VerifierException.class)
	public MipApiDataVO handleVerifierException(VerifierException e) {

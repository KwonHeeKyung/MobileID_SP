package mip.mva.verifier.push.service.impl;
...
import mip.mva.verifier.comm.vo.PushVO;
...
public class PushServiceImpl implements PushService {
	 ...
	 */
	@Override
	public T540VO start(T540VO t540) throws VerifierException {
		...
		try {
			PushVO pushVO = ConfigBean.gson.fromJson(pushResult, PushVO.class);

			if (!pushVO.getResult()) {
				throw new VerifierException(MipErrorEnum.UNKNOWN_ERROR, m200.getTrxcode(), push.getErrmsg());
			}
		} catch (JsonSyntaxException e) {
			throw new VerifierException(MipErrorEnum.MB_UNEXPECTED_MSG_FORMAT, m200.getTrxcode(), "pushResult");
		}
